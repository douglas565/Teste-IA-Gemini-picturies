...
import { analyzeLuminaireImage } from './services/geminiService';
  ...
  const handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      reader.onload = async () => {
        ...
        // Strip prefix (e.g., "data:image/jpeg;base64,") for API
        const base64Data = base64String.split(',')[1];

        const aiResponse = await analyzeLuminaireImage(base64Data, trainingData);

        const isLowConfidence = aiResponse.confidence < CONFIDENCE_THRESHOLD;
        const isMissingData = !aiResponse.model || !aiResponse.calculatedPower;
        ...
        const newResult: DetectionResult = {
          ...
          power: aiResponse.calculatedPower,
        ...
        // Auto-open modal if low confidence or missing data
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row">
      ...
      <aside className="w-full md:w-64 bg-slate-900 text-white p-6 flex flex-col md:fixed md:h-full z-10">
        <div className="flex items-center gap-3 mb-8">
           ...
           <h1 className="text-xl font-bold tracking-tight">LumiScan <span className="text-indigo-400">AI</span></h1>
        </div>

        <div className="space-y-6 flex-1">
          <div>
            <h3 className="text-xs uppercase tracking-wider text-slate-400 font-semibold mb-2">Base de Conhecimento</h3>
            ...
            <p className="text-xs text-slate-500 mt-2 leading-relaxed">
              O sistema aprende cada vez que você corrige uma detecção incerta.
            </p>
          </div>
        ...
        <div className="mt-auto pt-6 border-t border-slate-800">
          <p className="text-xs text-slate-500">Desenvolvido com Gemini Vision</p>
        </div>
      </aside>
      ...
      <main className="flex-1 md:ml-64 p-4 md:p-8 overflow-y-auto">
        ...
        <div className="max-w-5xl mx-auto mb-8">
           <div className="bg-white rounded-2xl shadow-sm border border-indigo-100 p-6 md:p-8 text-center relative overflow-hidden">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-2">Reconhecimento de Luminárias</h2>
              <p className="text-slate-500 mb-8 max-w-xl mx-auto">
                Faça o upload de uma foto da etiqueta ou da luminária. A IA identificará o modelo e calculará a potência automaticamente.
              </p>
                ...
                >
                  {isAnalyzing ? (
                    ...
                    <>
                      ...
                      <span className="font-semibold text-lg">Capturar / Upload</span>
                    </>
                  )}
                </label>
              </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          {history.length === 0 && !isAnalyzing && (
            <div className="text-center py-20 opacity-50">
               ...
               <p className="text-slate-400">Nenhuma imagem analisada ainda.</p>
            </div>
          )}
        </div>
      </main>
